		...
		class tempo_input
		{
		    ...
		    function logic( $args )
		    {
		        ...
		        return '<div class="' . esc_attr( $classes ) . '"'
		                ...
		                . '<span class="tempo-on">' . __( 'On' , 'tempo' ) . '</span>'
		                . '<span class="tempo-off">' . __( 'Off' , 'tempo' ) . '</span>'
		                . '</span>'

		                . '<div class="tempo-state-bkg">'
		                . '<div class="tempo-on"></div>'
		                . '<div class="tempo-null"></div>'
		                . '<div class="tempo-off"></div>'
		                . '</div>'
		                . $this -> hidden( $args )
		                . '</div>';
		    }
