		...
		'appearance' => array(
			'tempo-faq' => array(
			    ...
			    'sections' 	=> array(
				    ...
				    'child-themes'	=> array(
				    	'title' 		=> __( 'Tempo Child Themes', 'tempo' ),
						'description'	=> __( 'Here you can explore the Tempo child themes compatible with Zeon Premium WordPress Plugin.', 'tempo' ),
						'template'  	=> 'templates/admin/appearance/faq/child-themes',
						'style' 		=> array(
					...
					'zeon' => array(
						'title' 		=> __( 'Tempo + Zeon', 'tempo' ),
						'description'	=> sprintf( __( 'Zeon is a premium WordPress Plugin that extends the core functionality of the Tempo free WordPress theme and Tempo child themes.<br/> This means that after the upgrade to premium version you will not lose your settings or not you need to refill your website.', 'tempo' ), '<br/>' ),
