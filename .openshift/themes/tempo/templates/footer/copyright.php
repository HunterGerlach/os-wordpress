                ...
                <div <?php echo tempo_row_class(); ?>>
                    ...
                    <div <?php echo tempo_full_class(); ?>>
                        ...
                        <p>
                            ...
                            <span><?php printf( __( 'Designed by %s.' , 'tempo' ) , '<a href="' . esc_url( tempo_core::theme( 'AuthorURI' ) ) . '" target="_blank" title="' . esc_attr( tempo_core::theme( 'Author' ) ) . '">' . tempo_core::theme( 'Author' ) . '</a>' ); ?></span>
