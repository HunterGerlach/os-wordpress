...
jQuery(document).ready(function(){
	if( typeof tempo_customize_panel == 'object' && tempo_customize_panel.hasOwnProperty( 'premium_url' ) ){
	    if( jQuery( 'div#customize-theme-controls' ).length ){
	        jQuery( 'div#customize-theme-controls' ).append(
	            '<a href="' + tempo_customize_panel.premium_url + '" target="_blank" class="tempo-button tempo-submit-options">' +
    ...
    //- RANGER'S -//
    if( typeof tempo_customize_panel == 'object' && tempo_customize_panel.hasOwnProperty( 'range_reset_label' ) ){
