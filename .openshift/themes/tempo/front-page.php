                ...
                ?>
                    ...
                    <div <?php echo tempo_content_class(); ?>>
                        <div <?php echo tempo_row_class(); ?>>
                            ...
                            <?php tempo_get_template_part( 'templates/section/before', 'not-found-front-page' ); ?>

                            <section <?php echo tempo_404_section_class( 'tempo-section tempo-404 not-found front-page' ); ?>>

                                <?php tempo_get_template_part( 'templates/section/prepend', 'not-found-front-page' ); ?>

                                <?php tempo_get_template_part( 'templates/not-found', 'front-page' ); ?>

                                <?php tempo_get_template_part( 'templates/section/append', 'not-found-front-page' ); ?>

                            </section>

                            <?php tempo_get_template_part( 'templates/section/after', 'not-found-front-page' ); ?>
